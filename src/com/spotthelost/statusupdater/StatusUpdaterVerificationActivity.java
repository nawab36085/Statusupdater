...
public class StatusUpdaterVerificationActivity extends Activity {
	String TAG = "StatusUpdaterVerificationActivity";
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        rePasswordTextView.setText(R.string.enterverificationcode);
        registeringTextView.setText(R.string.verifyingdot);
        registerButton.setText(R.string.verify);
					...
					else
					{
						if(phoneNumberText.length() >= 0)
						{
							...
							if(passwordText.length() >= 0)
							{
								...
								{
									verificationCode = rePasswordText.toString();
										...
										new Thread(new Runnable(){
											...
											public void run() {
												...
												try {
									                  ...
									                  String postURL = "http://spotthelost.com/uploads/verify.php";
								            ...
								            { 
								        		if(msg.what == 1)
								        		{
								        	        ...
								        	        if(msg.obj != null)
								        	        {
								        	        	...
								        	        	Log.v(TAG, updateResult);
								        	        	registeringTextView.setText(updateResult);
								        	        	/*if(status.equals("success"))
								        	        	{
								        	        		registeringTextView.setText(R.string.verificationsuccess);
								        	        	}
								        	        	else if(status.equals("failure"))
								        	        	{
								        	        		registeringTextView.setText(R.string.verificationfailed);
								        	        	}
								        	        	else
								        	        	{
								        	        		registeringTextView.setText(R.string.verificationfailed);
